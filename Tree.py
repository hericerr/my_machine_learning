...
"""
import numpy as np
from util import get_MNIST, get_xor, get_donut, test_models_classification
...
class DecisionTree(object):
    ...
    def __str__(self):
        if self.max_depth is not None:
            return "DecisionTree(max_depth=%i)" %self.max_depth
        else:
            return "DecisionTree(Unlimited depth)"
...
if __name__ == '__main__':
    ...
    models = [DecisionTree(d) for d in range(1,4)]
